...
namespace SplinterTools
{
    ...
    public class SplinterModel
    {
        ...
        public Season_Details season_details { get; set; }
    }
    ...
    {
        public int level { get; set; }
        public int contrib_dec { get; set; }
        public int contrib_crowns { get; set; }
    }
    ...
    public class Barracks
    {
        ...
        public int[] away_blocked_cards { get; set; }
    }
